	...
	<?php if($this->_vars['add']){ ?>
		<form name="content" method="post" action="?action=add">
			<table cellspacing="0" class="content">
				...
				<tr><td>栏&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;目：<select name="nav"><option value="" style="padding: 0;">请选择一个栏目类别</option><?php echo $this->_vars['nav'];?></select><span class="red">(*必选)</span></td></tr>
				...
				<tr><td>作&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;者：<input type="text" name="author" class="text" value="<?php echo $this->_vars['author'];?>"></td></tr>
